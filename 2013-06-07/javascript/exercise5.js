...
var street1 = DOMAIN([[25,27], [27, 50], [0.3, 1.01]])([1,1,1]);
var street2 = DOMAIN([[34.5, 36.5], [27, 50], [0.3, 1.01]])([1,1,1]);
var street3 = DOMAIN([[44,46], [27, 50], [0.3, 1.01]])([1,1,1]);
var street4 = DOMAIN([[27,44], [37, 39], [0.3, 1.01]])([1,1,1]);

var streets1 = STRUCT([street1, street2, street3, street4]);

///
var street5 = DOMAIN([[-50, -48], [30.55, 44.55], [0.3, 1.01]])([1,1,1]);
var street6 = DOMAIN([[-48, -41], [30.55, 32.55], [0.3, 1.01]])([1,1,1]);
var street7 = DOMAIN([[-48, -41], [42.55, 44.55], [0.3, 1.01]])([1,1,1]);
var street8 = DOMAIN([[-41, -39], [30.55, 50], [0.3, 1.01]])([1,1,1]);
var street9 = DOMAIN([[-39, -29], [48, 50], [0.3, 1.01]])([1,1,1]);
var street10 = DOMAIN([[-39, -29], [36.5, 38.5], [0.3, 1.01]])([1,1,1]);
var street11 = DOMAIN([[-31, -29], [38.5, 48], [0.3, 1.01]])([1,1,1]);



var streets2 = STRUCT([street5, street6, street7, street8, street9, street10, street11]);

var colorStreets = [0.7, 0.7, 0.7];

streets1 = COLOR([colorStreets])(streets1);
streets2 = COLOR([colorStreets])(streets2);
